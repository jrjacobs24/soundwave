...
class TJ_Twitter extends WP_Widget {
   ...
   function widget($args, $instance) {  
	...
	?>
		...
		<div class="follow-user"><a href="https://twitter.com/<?php echo $username; ?>" class="twitter-follow-button">Follow @<?php echo $username; ?></a><script src="//platform.twitter.com/widgets.js" type="text/javascript"></script></div>
