...
if(isset($_POST['submitted'])) {
    ...
    if(!isset($hasError)) {
        $emailTo = get_option('blacklight_email');
...
<div id="content">
    ...
    <h1 class="pagetitle"><?php _e( 'Contact Us' ); ?></h1>
        ...
        <div class="entry">
            ...
            <form action="<?php the_permalink(); ?>" id="contact-form" method="post" class="clear">
                <ul class="contact-form">
                    <li>
                        <label for="contactName"><?php _e('Name:', 'themejunkie') ?></label>
                    ...
                    <li>
                        <label for="email"><?php _e('Email:', 'themejunkie') ?></label>
                    ...
                    <li class="textarea">
                        <label for="commentsText"><?php _e('Message:', 'themejunkie') ?></label>
