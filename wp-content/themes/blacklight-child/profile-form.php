...
<div class="login profile" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<?php
		...
		<tr id="password">
			...
			<td><input type="password" name="pass1" id="pass1" size="16" value="" autocomplete="off" /> <span class="description"><?php _e( 'Leave blank unless changing to new password' ); ?></span><br />
		...
		<tr>
			...
			<span class="description"><?php _e( 'Share a little bit about yourself. This may be shown publicly.' ); ?></span></td>
		</tr>
