...
<form method="post" action="options.php">
    ...
    <table class="form-table">		
		...
		<label><input name="default_style" type="radio" value="BlurPurple" <?php checked( 'BlurPurple', get_option( 'default_style' ) ); ?> />Blur Purple</label><br />
		<label><input name="default_style" type="radio" value="SimpleFlat" <?php checked( 'SimpleFlat', get_option( 'default_style' ) ); ?> />Simple Flat</label>
