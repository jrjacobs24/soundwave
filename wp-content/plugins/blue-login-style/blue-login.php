...
Description: Blue Login Style is a tiny plugin which allows to customize your wp-login style easily with a click.
Version: 1.2.1
Author: Ali Mirzaei
...
function custom_login_style()
{
	...
	else if ($options == "SimpleFlat"){
	echo '<link rel="stylesheet" type="text/css" href="' . plugins_url('css/simpleFlat.css', __FILE__) . '" />';
		if ( is_rtl() ) {
			echo '<link rel="stylesheet" type="text/css" href="' . plugins_url('css/rtl2.css', __FILE__) . '" />';
		}			
	}	
