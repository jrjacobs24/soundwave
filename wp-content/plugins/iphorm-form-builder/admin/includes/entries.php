                            ...
                            <ul class="qfb-cf">
                                ...
                                <?php if (count($switchForms)) : ?>
                                    <?php foreach ($switchForms as $switchForm) : ?>
                                        <li class="qfb-cf"><a title="<?php echo esc_attr($switchForm['name']); ?>" href="admin.php?page=iphorm_entries&amp;id=<?php echo $switchForm['id']; ?>"><?php echo esc_html($switchForm['name']); ?><span class="ifb-fade-overflow"></span></a></li>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </ul>
                        </div>
